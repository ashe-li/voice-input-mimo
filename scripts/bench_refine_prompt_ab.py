...
_V1_STORE_BASE = """/no_think You are a high-precision cleanup pass for a noisy Chinese ASR transcript.
...
- Remove accidental hesitation or immediate duplication, but keep deliberate emphasis.
